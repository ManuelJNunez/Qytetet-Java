...
public class Tablero {
    ...
    private void inicializar(){
        ...
        this.casillas.add(new OtraCasilla (0, TipoCasilla.SALIDA, 1000));
        ...
        this.casillas.add(new OtraCasilla (13, TipoCasilla.SORPRESA));
        ...
        this.casillas.add(new OtraCasilla (18, TipoCasilla.IMPUESTO, 250));
